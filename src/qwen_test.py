...
# sys.path.append('ddk/tools_dopt/dopt_pytorch_py3/dopt')
os.environ["CUDA_VISIBLE_DEVICES"] = "0"


def get_quanted_model(base_model, dopt_config, quanted_ckpt):
    from dopt.dopt_lm.do_opt import (optimize_model, set_quant_state, set_calibrate_state, set_run_mode,)
...
if __name__ == '__main__':
    ...
    quant_res_root = 'dopt_out'
    # 量化配置
    dopt_config = "dopt_conf/qwen2.5-0.5b.json"
    # 量化权重
    quanted_ckpt = "dopt_out/trained.pth"
